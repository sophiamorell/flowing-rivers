...
| 26 | Form delivery via Netlify Forms | ✅ Closed 2026-09-10: form detection on, email notification set, test submission delivered. Netlify free tier allows 100 submissions a month. | `public/__forms.html`, Netlify → Forms |
